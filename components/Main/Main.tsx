    ...
    <>
      <section className='flex items-center justify-center flex-col h-fit'>
        ...
        <div className='mt-5 w-full'>
          <div className='mx-10 mb-10 gap-5 md:mx-auto grid grid-cols-1 md:grid-cols-[1fr_3fr] gap-x-5 md:w-3/4 md:min-h-3/4 min-h-[45rem] h-fit '>
            <LeftContent />
            <RightContent />
          </div>
        </div>
